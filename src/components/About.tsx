  ...
  return (
    ...
    >
      ...
      <motion.img
        src="/linkedin.png"
        alt=""
        className="w-40 h-40 -mb-32 md:mb-0 flex-shrink-0 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px]"
        initial={{
          x: -200,
          opacity: 0,
        }}
      ...
      <div className="space-y-10 px-0 md:px-10">
        <h4 className="text-2xl md:text-4xl font-semibold text-[#0076B6] underline">
          A little about me
        </h4>
        <p className="text-sm md:text-base">
          Wow so where do I start? I actually was a Medical Laboratory
